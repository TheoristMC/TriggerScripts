...
TriggerScripts is originally from a game called [Worlds FRVR](https://worlds.frvr.com/) which enables users to essentially trigger scripts set by appropriate players. 
